...
4. By default, PostgreSQL sets up a role/user named "postgres" that you can use to access the database. To switch to this user, run:

   #+begin_src
   sudo -i -u postgres
   #+end_src

5. Now you can access the PostgreSQL shell:
